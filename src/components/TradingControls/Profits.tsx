        ...
        <div key={item} className="line">
          <div className="inputLeft">
            ...
            <input
              ...
              className="placeholder:text-[rgba(255,255,255,0.60)] w-full text-white outline-none"
          ...
          <div className="inputRight">
            <input
              ...
              className="flex-grow placeholder:text-[rgba(255,255,255,0.60)] w-full text-white outline-none"
